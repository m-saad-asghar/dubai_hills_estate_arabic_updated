...
const WhatsAppButton = () => {
  ...
  const saveToBitrix = async () => {
    ...
    const payload = {
      fields: {
        TITLE: "Dubai Creek Harbour AR Landing Page From Whatsapp Button",
        ...
        UF_CRM_1754652292782:
          "Dubai Creek Harbour AR Landing Page From Whatsapp Button",
      ...
      >
        {showTooltip && (
           <div
            ...
            dir="rtl"
          >
            تواصل معنا عبر الواتساب للحصول على إرشادات فورية حول العقارات!
          </div>
        )}
